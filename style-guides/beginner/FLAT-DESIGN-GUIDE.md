...
- [ ] Bright, vibrant color palette (4-6 colors)
- [ ] Solid colors only (no gradients)
- [ ] Simple geometric shapes (rectangles, circles)
- [ ] Clean sans-serif typography throughout
- [ ] Bold headings for hierarchy
- [ ] Large color blocks (not minimal use)

### UI Elements
- [ ] Rectangular cards with minimal rounding (0-4px)
- [ ] Buttons clearly defined by color (not just borders)
- [ ] Line-style icons (outline, not filled)
- [ ] Consistent icon stroke weight (2-3px)
- [ ] Large touch targets (44x44px minimum)
- [ ] No drop shadows anywhere
- [ ] Hover states: color shifts only (no elevation)

### Layout
- [ ] Clean grid system (12-column responsive)
- [ ] Generous spacing between elements
- [ ] Everything aligned to grid
- [ ] Card-based layouts for content
- [ ] Full-bleed color blocks
- [ ] Single z-index (no layering depth)

### Color Usage
- [ ] Vibrant, saturated colors (not muted)
- [ ] Color-coded UI (blue primary, red danger, green success)
- [ ] High contrast for readability
- [ ] No color mixing or gradients
- [ ] Light backgrounds (#ECF0F1) or white
- [ ] Dark text on light or vice versa (clear contrast)

### Typography
- [ ] Sans-serif fonts only (Open Sans, Lato, Roboto)
- [ ] Bold or semi-bold for all headings
- [ ] Clear type hierarchy (size + weight)
- [ ] 16px minimum for body text
- [ ] Generous line-height (1.5-1.6)
- [ ] All caps for labels/buttons (optional)

### Icons & Graphics
- [ ] Simple line icons (outline style)
- [ ] Minimal detail (essential shapes only)
- [ ] Consistent stroke weight across all icons
- [ ] Flat illustrations (no shading)
- [ ] Geometric shapes (circles, squares, triangles)
- [ ] No 3D effects or perspective

### Overall Feel
- [ ] Feels digital and modern (not physical)
- [ ] Colorful and energetic (not stark)
- [ ] Clean and simple (not cluttered)
- [ ] Two-dimensional (completely flat)
- [ ] Functional and clear (content-focused)

### Accessibility
- [ ] Color contrast meets WCAG AA (4.5:1 text)
- [ ] Buttons clearly identifiable (not just color)
- [ ] Interactive elements have clear states
- [ ] Text readable against colored backgrounds
